...
import com.dubcast.bff.model.ChatRequest
import com.dubcast.bff.model.ChatResponse
import com.dubcast.bff.model.Proposal
import com.dubcast.bff.model.ToolCall
import com.dubcast.bff.service.ChatToolDefs
import com.dubcast.bff.service.GeminiChatResult
...
fun Route.chatRoutes(geminiClient: GeminiClient) {
    post("/chat") {
        ...
        val result = runCatching { geminiClient.chat(turns, tools, systemInstruction) }
            .getOrElse { e ->
                call.respond(HttpStatusCode.InternalServerError, mapOf("error" to (e.message ?: "Gemini error")))
                return@post
            }
