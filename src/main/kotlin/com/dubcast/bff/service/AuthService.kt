...
import com.dubcast.bff.config.AuthConfig
import com.dubcast.bff.model.AuthResponse
import com.dubcast.bff.model.AuthUser
import com.dubcast.bff.model.GoogleTokenInfo
...
class AuthService(
    ...
    suspend fun verifyGoogleIdToken(idToken: String): AuthUser {
        ...
        if (!response.status.isSuccess()) {
            log.warn("Google tokeninfo returned {}: {}", response.status.value, response.bodyAsText().take(200))
