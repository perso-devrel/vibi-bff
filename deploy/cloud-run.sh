...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-env-vars="^@^GEMINI_PROJECT_ID=${GEMINI_PROJECT_ID}@GEMINI_LOCATION=${REGION}@PERSO_BASE_URL=https://api.perso.ai@PERSO_STORAGE_BASE_URL=https://portal-media.perso.ai@STORAGE_PATH=/tmp/storage@GOOGLE_OAUTH_CLIENT_IDS=${GOOGLE_OAUTH_CLIENT_IDS}@CORS_ALLOWED_ORIGINS=${CORS_ALLOWED_ORIGINS}@GCS_BUCKET=${GCS_BUCKET}@GCS_SIGNED_URL_TTL_SEC=${GCS_SIGNED_URL_TTL_SEC}" \
